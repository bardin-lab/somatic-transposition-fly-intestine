...
for gff_file, insertion_set in zip(gff_files, INSERTION_SET):
    ...
    pm.execute_notebook('damid_overlap_data.ipynb', "%s_notebook.ipynb" % insertion_set.lower().replace(' ', '_'), parameters=dict(all_insertions=gff_file, INSERTION_SET=insertion_set))
